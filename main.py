...
class Starter:
  ...
  # continue Button
        ...
        self.continue_button = Button(parent, text='Next', bg='orange',
...
class Questions:
    ...
    def __init__(self, parent):
        self.quiz_questions = {
            ...
            4: [
                'How is the Green Lantern Ring fueled?',
                'Willpower',
                'Hope',
                'Justice',
                'Virtue',
            ...
            5: [
                'Did the Fanstic Four get powers by: ',
                'A Gentic mutation',
                'A Chemical Spill',
                'Cosmic rays',
            ...
            8: [
                'Who is Dwayne Johnson in Fast and Furious?',
                'Deckard Shaw',
                'Luke Hobbs',
                'Victor Loke',
                'Jonah',
            ...
            9: [
                "In 'The Batman', who was the main villan",
                'Carmine Falcone',
                'The Penguin',
                'The Riddler',
                'The Joker',
            ...
            10: [
                'Who is the Chosen One in Starwars',
                'Luke Skywalker',
                'Anakin Skywalker',
                'Rey Skywalker',
                'Chewbacca',
    ...
    # self.quiz_frame.grid()
      ...
      # label widget for our Question
        ...
        self.question_label = Label(
            parent,
            text=self.quiz_questions[qnum][0],
            font=('Times', '16', 'bold'),
            bg='aliceblue',
            height='2',
            justify='center',
      ...
      # Radio button 1
        ...
        self.rb1 = Radiobutton(
            parent,
            text=self.quiz_questions[qnum][1],
        ...
        self.rb2 = Radiobutton(
            parent,
            text=self.quiz_questions[qnum][2],
            font=('Courier', '12', 'bold'),
            bg='lightyellow',
            value=2,
            padx=10,
        ...
        self.rb3 = Radiobutton(
            parent,
            text=self.quiz_questions[qnum][3],
            font=('Courier', '12', 'bold'),
            bg='lightyellow',
            value=3,
            padx=10,
        ...
        self.rb4 = Radiobutton(
            parent,
            text=self.quiz_questions[qnum][4],
            font=('Courier', '12', 'bold'),
            bg='lightyellow',
            value=4,
            padx=10,
    ...
    # Confrim answer button
        ...
        self.score_label = Label(parent, text='Score', font=('Courier',
                                 '11'), bg='whitesmoke', height='2')
    ...
    def testing(self):
        ...
        if len(asked) > 9:
            if choice == self.quiz_questions[qnum][6]:
                ...
                score += 0
                points_label.configure(text='Correct Answer: '
                        + self.quiz_questions[qnum][5])
                self.confirm_button.config(text='Confirm')
                self.ending()
        else:
            if choice == 0:
...
class Ending:
    ...
    def __init__(self):
        ...
        self.ending_frame = Frame(opened, bg=background, padx=130,
                                  pady=260)
